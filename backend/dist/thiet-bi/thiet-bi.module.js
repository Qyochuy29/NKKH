...
const thiet_bi_dieu_khien_1 = require("./thiet-bi.dieu-khien");
...
exports.ThietBiModule = ThietBiModule = __decorate([
    (0, common_1.Module)({
        controllers: [thiet_bi_dieu_khien_1.ThietBiDieuKhien],
        providers: [thiet_bi_xu_ly_1.ThietBiXuLy],
        exports: [thiet_bi_xu_ly_1.ThietBiXuLy],
    })
], ThietBiModule);
